...
public class Router5 {
    ...
    private static final int PORT = 2005; //dinle
    private static final int PORT2 = 2003; //gonder
    private static final int PORT3 = 2008;
    ...
    public static void main(String[] args) {
        ...
        if (randomSayi == 0) {
            ...
            try {
                ...
                link2 = new Socket(host, PORT);
                System.out.println("Gidilen Router 8");
            } catch (IOException ioEx) {
                System.out.println(
                        "Receiver baglanti noktasina baglanamiyor");
                System.exit(1);
